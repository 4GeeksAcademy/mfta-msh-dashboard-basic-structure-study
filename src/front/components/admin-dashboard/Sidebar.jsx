...
const Sidebar = () => {
    return (
        <div className="d-flex flex-column flex-shrink-0 p-3 bg-dark text-white h-100">
            ...
            <div className="offcanvas-lg offcanvas-end lg-show text-bg-dark" style={{ width: '200px'}} tabIndex={-1} id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
